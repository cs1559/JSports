...
/*
 * Removed as part of rule changes to SWIBL for 2025
...
<h1><?php //echo $this->team->name; ?> Add/Edit Player</h1>
<form action="<?php echo Route::_('index.php?option=com_jsports&view=roster&layout=player&id=' . (int) $this->item->id); ?>"
