...
<div class='jsports-text-campaign-container' style='width:100%; '>
    ...
    <div id='jsports-campaign-<?php echo $campaign->id; ?>-<?php echo $position; ?>' class='jsports-text-campaign-content <?php echo $campaign->classname; ?>'>
    <a class='jsports-img-link' target='_blank' href='<?php echo $campaign->getClickUrl(); ?>' rel='noopener noreferrer'>
