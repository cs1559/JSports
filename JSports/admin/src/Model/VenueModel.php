...
//     }
    ...
    {
        // Get the form.
        $form = $this->loadForm('com_jsports.venue', 'venue', array('control' => 'jform', 'load_data' => $loadData));
    ...
    protected function loadFormData()
    {
        ...
        $data = $app->getUserState('com_jsports.edit.venue.data', array());
        ...
        $this->preprocessData('com_jsports.venue', $data);
