 ...
 *
 */
namespace FP4P\Component\JSports\Administrator\View\Divisions;
...
class HtmlView extends BaseHtmlView
{
    ...
    protected function addToolBar()
    {
        ...
        ToolbarHelper::title(Text::_('Sports Managment - Divisions'));
               
        $canDo = ContentHelper::getActions('com_jsports');       
        
        if ($canDo->get('core.create'))
        {
            $toolbar->addNew('division.add');
        }
        ...
        if ($canDo->get('core.edit.state'))
        {
            ...
            $childBar->publish('divisions.publish')->listCheck(true);
            
            $childBar->unpublish('divisions.unpublish')->listCheck(true);
            
            $childBar->archive('divisions.archive')->listCheck(true);
        ...
        {
            $toolbar->delete('divisions.delete')
