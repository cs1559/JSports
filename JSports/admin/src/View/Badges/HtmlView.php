 ...
 */
namespace FP4P\Component\JSports\Administrator\View\Badges;
...
class HtmlView extends BaseHtmlView
{
    ...
    protected function addToolBar()
    {
        ...
        ToolbarHelper::title(Text::_('Sports Managment - Badges'));
               
        $canDo = ContentHelper::getActions('com_jsports');       
        
        if ($canDo->get('core.create'))
        {
            $toolbar->addNew('badge.add');
        }
        ...
        if ($canDo->get('core.edit.state'))
        {
            ...
            $childBar->publish('badges.publish')->listCheck(true);
            
            $childBar->unpublish('badges.unpublish')->listCheck(true);
            
//             $childBar->archive('badges.archive')->listCheck(true);
            
            if ($this->state->get('filter.published') != -2)
            {
                $childBar->trash('badges.trash')->listCheck(true);
            }
        }
