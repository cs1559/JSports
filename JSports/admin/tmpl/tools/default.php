...
These are a collection of tools that can be used to manage your JSports installation.
    ...
    <table>
        ...
        <tr><td><a href="index.php?option=com_jsports&view=auditTeamProfiles"><button class="btn btn-primary">Audit Team Profiles</button></a></td><td>Purge recoreds from the JSports log table.</td></tr>
    </table>
