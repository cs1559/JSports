...
<form action="<?php echo Route::_('index.php?option=com_jsports&view=badges'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<?php else : ?>
		<table class="table" id="badgesList">
			<thead>
				<tr>
					...
					<th scope="col" class="w-30">
						<?php echo Text::_('COM_JSPORTS_AWARD'); ?>
					</th>
					<th scope="col" class="w-30">
						<?php echo Text::_('COM_JSPORTS_TEAM'); ?>
					</th>
...
//     $canChange  = $user->authorise('core.edit.state', 'com_modules.module.' . $item->id) && $canCheckin; 
                    $canChange  = $user->authorise('core.edit.state', 'com_jsports.badges.' . $item->id);

?>
                 <td class="text-center">   
                        <?php //echo HTMLHelper::_('jgrid.published', $item->published, $i, 'modules.', $canChange, 'cb', $item->publish_up, $item->publish_down); ?>
                        <?php echo HTMLHelper::_('jgrid.published', $item->published, $i,'badges.', $canChange);  ?>
                 
                </td>
					<th scope="row" class="has-context">
						<a class="hasTooltip" href="<?php echo Route::_('index.php?option=com_jsports&task=badge.edit&id=' . $item->id); ?>">
