			...
			<thead>
				<tr>
					...
					<th scope="col" class="w-20">
						...
						<?php echo Text::_('COM_JSPORTS_ADDRESS'); ?>
					</th>					
...
<?php 
//     $canChange  = $user->authorise('core.edit.state', 'com_modules.module.' . $item->id) && $canCheckin; 
                    $canChange  = $user->authorise('core.edit.state', 'com_jsports.venues.' . $item->id);
...
?>
                 <td class="text-center">   
					...
					<th scope="row" class="has-context">
						<a class="hasTooltip" href="<?php echo Route::_('index.php?option=com_jsports&task=venue.edit&id=' . $item->id); ?>">
