...
?>
<form action="<?php echo Route::_('index.php?option=com_jsports&view=leagues'); ?>" method="post" name="adminForm" id="adminForm">
	...
	<?php else : ?>
		<table class="table" id="leaguesList">
			<thead>
				<tr>
...
<?php 
//     $canChange  = $user->authorise('core.edit.state', 'com_modules.module.' . $item->id) && $canCheckin; 
                $canChange  = $user->authorise('core.edit.state', 'com_jsports.leagues.' . $item->id);

?>
                 <td class="text-center">   
                        <?php //echo HTMLHelper::_('jgrid.published', $item->published, $i, 'modules.', $canChange, 'cb', $item->publish_up, $item->publish_down); ?>
                        <?php echo HTMLHelper::_('jgrid.published', $item->published, $i,'leagues.', $canChange);  ?>
                 
                </td>


					<th scope="row" class="has-context">
						<a class="hasTooltip" href="<?php echo Route::_('index.php?option=com_jsports&task=league.edit&id=' . $item->id); ?>">
